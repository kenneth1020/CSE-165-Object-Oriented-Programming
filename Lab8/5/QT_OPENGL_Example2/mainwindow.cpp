...
void MainWindow::paintGL()
{
    ...
    glRotatef(rotation,0.3f,-0.5f,0.5f);
    ...
    glEnd();
        ...
        // RIGHT
    glBegin(GL_POLYGON);
        glColor3f(0.0f, 0.4f, 1.0f); //Green
        glVertex3f(0.5f, -0.5f, -0.5f);
        glVertex3f(0.5f, 0.5f, -0.5f);
        glVertex3f(0.5f, 0.5f, 0.5f);
        glVertex3f(0.5f, -0.5f, 0.5f);
    glEnd();
     ...
     // TOP
    glBegin(GL_POLYGON);
        glColor3f(1.0f, 0.7f, 0.1f); //orange
        glVertex3f(0.5f, 0.5f, 0.5f);
        glVertex3f(0.5f, 0.5f, -0.5f);
        glVertex3f(-0.5f, 0.5f, -0.5f);
        glVertex3f(-0.5f, 0.5f, 0.5f);
    ...
    // BOTTOM
   glBegin(GL_POLYGON);
       glColor3f(0.0f, 1.0f, 0.7f); // dark green
       glVertex3f(0.5f, -0.5f, -0.5f);
       glVertex3f(0.5f, -0.5f, 0.5f);
       glVertex3f(-0.5f, -0.5f, 0.5f);
       glVertex3f(-0.5f, -0.5f, -0.5f);
